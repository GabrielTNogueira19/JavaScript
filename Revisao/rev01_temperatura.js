// EXERCÍCIO 01 - Classificação com limites de
// faixa

// Condicionais e testes de
// fronteira
...
if (temperatura <= 60){
    console.log(`Temperatura ${temperatura} °C esta NORMAL`);
} else if (temperatura <= 80){
    console.log(`Temperatura ${temperatura} °C esta em estado de ATENCAO`);
} else{
    console.log(`Temperatura ${temperatura} °C esta CRITICA`);
};